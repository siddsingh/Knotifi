...
//  that creates a new managed object context hat talks to a single persistent store coordinator
...
@implementation KNDataStore

static KNDataStore *sharedInstance;
...
+ (void)initialize
{
    ...
    {
        exists = YES;
        sharedInstance= [[KNDataStore alloc] init];
    }
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Knotifi" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Knotifi.sqlite"];
